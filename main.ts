...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    pause(1500)
    controller.moveSprite(mySprite, 65, 95)
    music.play(music.createSoundEffect(WaveShape.Noise, 5000, 0, 255, 70, 500, SoundExpressionEffect.Warble, InterpolationCurve.Curve), music.PlaybackMode.UntilDone)
})
let mySprite2: Sprite = null
let mySprite3: Sprite = null
let projectile: Sprite = null
let mySprite: Sprite = null
music.play(music.createSong(assets.song`Ryan Dunn`), music.PlaybackMode.LoopingInBackground)
...
forever(function () {
    ...
    mySprite,
    assets.animation`David Midflight`,
    500,
    false
    )
    pause(500)
